...
type Config struct {
	...
	RecoveryEnabled    bool   `yaml:"recovery_enabled" default:"false" usage:"allows to enable recovery from panics. available only for default grpc sevrer" example:"false"`
}
